    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupAdmins", x => new { x.GroupChatId, x.UserId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GroupAdmins_GroupChats_GroupChatId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupUsers", x => new { x.GroupChatId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PrivateChats_AspNetUsers_FirstUserId",
                        column: x => x.FirstUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PrivateChats_AspNetUsers_SecondUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PrivateChats_FirstUserId",
                table: "PrivateChats",
                column: "FirstUserId");

            migrationBuilder.CreateIndex(
                name: "IX_PrivateChats_SecondUserId",
                table: "PrivateChats",
                column: "SecondUserId");
